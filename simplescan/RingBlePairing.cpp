...
char BlePairing::mPublicPayload[ATT_MTU_MAX] =
                "12345678980123456789801234567898012345678980123456789801234567898012345678980123456789801234567898012345678980"
                "12345678980123456789801234567898012345678980123456789801234567898012345678980123456789801234567898012345678980"
                "placeholder for public payload generated by GATT server";
...
int BlePairing::Initialize(char *aDeviceName)
{
    ...
    AttributeInfo_t *attribute_list = sServiceTable[RING_PAIRING_SVC_IDX].AttributeList;
    ((CharacteristicInfo_t*) (attribute_list[GET_PUBLIC_PAYLOAD].Attribute))->Value = (Byte_t *) BlePairing::mPublicPayload;
    ((CharacteristicInfo_t*) (attribute_list[GET_PUBLIC_PAYLOAD].Attribute))->ValueLength = strlen(BlePairing::mPublicPayload);
