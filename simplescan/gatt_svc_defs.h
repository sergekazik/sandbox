...
RING_BLE_PAIRING_SERVICES_DEFINE( 7, SET_PROVISION     , Ble::Property::_W_, 32, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(04), MAKEPAYLOAD("<network></network>"))
...
RING_BLE_PAIRING_SERVICES_DEFINE(11, SET_COUNTRY_CODE  , Ble::Property::_W_,  4, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(06), MAKEPAYLOAD(""))
