...
RING_BLE_PAIRING_SERVICES_DEFINE( 3, GET_PUBLIC_PAYLOAD, Ble::Characteristic::RW_, 28, GATM_SECURITY_PROPERTIES_NO_SECURITY, MAKERINGUUID(02), MAKEPAYLOAD(""))
RING_BLE_PAIRING_SERVICES_DEFINE( 5, GET_NETWORKS      , Ble::Characteristic::R__, 28, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(03), MAKEPAYLOAD(""))
RING_BLE_PAIRING_SERVICES_DEFINE( 7, SET_NETWORK       , Ble::Characteristic::_W_,  8, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(04), MAKEPAYLOAD(""))
RING_BLE_PAIRING_SERVICES_DEFINE( 9, GET_PAIRING_STATE , Ble::Characteristic::R_N,  1, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(07), MAKEPAYLOAD("IDLE"))
RING_BLE_PAIRING_SERVICES_DEFINE(11, SET_LANGUAGE      , Ble::Characteristic::_W_,  1, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(08), MAKEPAYLOAD(""))
RING_BLE_PAIRING_SERVICES_DEFINE(13, SET_ZIPCODE       , Ble::Characteristic::_W_,  1, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(09), MAKEPAYLOAD(""))
RING_BLE_PAIRING_SERVICES_DEFINE(15, GET_WIFI_STATUS   , Ble::Characteristic::R__,  1, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(0A), MAKEPAYLOAD("DISCONNECTED"))
RING_BLE_PAIRING_SERVICES_DEFINE(17, GET_SSID_WIFI     , Ble::Characteristic::R__,  2, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(0B), MAKEPAYLOAD("Doorbells"))
RING_BLE_PAIRING_SERVICES_DEFINE(19, GET_SERIAL_NUMBER , Ble::Characteristic::R__,  2, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(0C), MAKEPAYLOAD(""))
RING_BLE_PAIRING_SERVICES_DEFINE(21, GET_MAC_ADDRESS   , Ble::Characteristic::R__,  1, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(0D), MAKEPAYLOAD("01:02:03:04:05:0F"))
