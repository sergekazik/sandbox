...
// Note: due to GATT limitation max payload is 512 bytes (including encryption overhead)
// The table below contains max size in 18-bytes packets, so the max is 28.4 packets (of 18 bytes each) - here 29
...
RING_BLE_PAIRING_SERVICES_DEFINE( 5, GET_AP_LIST       , Ble::Property::R__, 29, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(03), MAKEPAYLOAD("<ap_list></ap_list>"))
RING_BLE_PAIRING_SERVICES_DEFINE( 7, SET_PROVISION     , Ble::Property::RW_, 29, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(04), MAKEPAYLOAD("<network></network>"))
...
RING_BLE_PAIRING_SERVICES_DEFINE(21, GET_SSID_WIFI     , Ble::Property::R__,  4, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(0B), MAKEPAYLOAD("Ring"))
RING_BLE_PAIRING_SERVICES_DEFINE(23, GET_SERIAL_NUMBER , Ble::Property::R__,  4, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(0C), MAKEPAYLOAD("123456789"))
RING_BLE_PAIRING_SERVICES_DEFINE(25, GET_MAC_ADDRESS   , Ble::Property::R__,  3, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(0D), MAKEPAYLOAD("DE:AD:BE:AF:AB:BA"))
