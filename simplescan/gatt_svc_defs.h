...
RING_BLE_PAIRING_SERVICES_DEFINE( 1, SET_PUBLIC_KEY    , Ble::Property::_W_, 28, GATM_SECURITY_PROPERTIES_NO_SECURITY, MAKERINGUUID(01), MAKEPAYLOAD(""))
RING_BLE_PAIRING_SERVICES_DEFINE( 3, GET_PUBLIC_PAYLOAD, Ble::Property::RW_, 28, GATM_SECURITY_PROPERTIES_NO_SECURITY, MAKERINGUUID(02), MAKEPAYLOAD("5fb4884b153786ffcadea0c82bae14eb3fd0c2cd323cd798e4f046e9f7c47c239f8e04b2c5a22a9e2cbc1da50640552dae381bfa87ea0da6a2b3cb9d714b1e79b186107ddbb51063ff21d7c2aaa9edbca4b0e450acefec5037b05bab9099c50581ca3dd5e598fe84e9f12cd82c484859cb1cf45c"))
...
RING_BLE_PAIRING_SERVICES_DEFINE( 7, SET_PROVISION     , Ble::Property::_W_, 28, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(04), MAKEPAYLOAD("<network></network>"))
RING_BLE_PAIRING_SERVICES_DEFINE( 9, SET_SECRET_KEY    , Ble::Property::_W_,  2, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(05), MAKEPAYLOAD(""))
RING_BLE_PAIRING_SERVICES_DEFINE(11, SET_COUNTRY_CODE  , Ble::Property::_W_,  2, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(06), MAKEPAYLOAD(""))
RING_BLE_PAIRING_SERVICES_DEFINE(13, GET_PAIRING_STATE , Ble::Property::R_N,  1, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(07), MAKEPAYLOAD("IDLE"))
RING_BLE_PAIRING_SERVICES_DEFINE(15, SET_LANGUAGE      , Ble::Property::_W_,  1, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(08), MAKEPAYLOAD(""))
RING_BLE_PAIRING_SERVICES_DEFINE(17, SET_ZIPCODE       , Ble::Property::_W_,  1, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(09), MAKEPAYLOAD(""))
RING_BLE_PAIRING_SERVICES_DEFINE(19, GET_WIFI_STATUS   , Ble::Property::R__,  1, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(0A), MAKEPAYLOAD("DISCONNECTED"))
RING_BLE_PAIRING_SERVICES_DEFINE(21, GET_SSID_WIFI     , Ble::Property::R__,  2, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(0B), MAKEPAYLOAD("Doorbells"))
RING_BLE_PAIRING_SERVICES_DEFINE(23, GET_SERIAL_NUMBER , Ble::Property::R__,  2, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(0C), MAKEPAYLOAD("BHRC11728CH003122"))
RING_BLE_PAIRING_SERVICES_DEFINE(25, GET_MAC_ADDRESS   , Ble::Property::R__,  1, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(0D), MAKEPAYLOAD("38D269F27E01"))
...
RING_BLE_PAIRING_SERVICES_DEFINE(29, SET_REG_DOMAIN    , Ble::Property::_W_,  1, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(0F), MAKEPAYLOAD("US"))
