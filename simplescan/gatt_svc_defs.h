...
RING_BLE_PAIRING_SERVICES_DEFINE( 5, GET_NETWORKS      , Ble::Characteristic::R__, 28, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(03), MAKEPAYLOAD("Doorbells,DLG,LpdPodA"))
RING_BLE_PAIRING_SERVICES_DEFINE( 7, SET_WIFI_NETWORK  , Ble::Characteristic::_W_,  4, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(04), MAKEPAYLOAD(""))
...
RING_BLE_PAIRING_SERVICES_DEFINE(23, GET_SERIAL_NUMBER , Ble::Characteristic::R__,  2, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(0C), MAKEPAYLOAD(""))
RING_BLE_PAIRING_SERVICES_DEFINE(25, GET_MAC_ADDRESS   , Ble::Characteristic::R__,  1, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(0D), MAKEPAYLOAD("01:02:03:04:05:0F"))
