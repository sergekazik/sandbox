...
RING_BLE_PAIRING_SERVICES_DEFINE( 3, GET_PUBLIC_PAYLOAD, Ble::Property::RW_, 28, GATM_SECURITY_PROPERTIES_NO_SECURITY, MAKERINGUUID(02), MAKEPAYLOAD("PUBLIC PAYLOAD KEY NONCE PLACEHOLDER"))
