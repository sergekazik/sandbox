...
#define RING_BLE_GATT_SERVER_TEST_DEFINE(__arg1, __arg2)
#define RING_BLE_PAIRING_SERVICES_DEFINE(__arg0, __arg1, __arg2, __arg3, __arg4, __arg5)   __arg1,
#endif
...
RING_BLE_PAIRING_SERVICES_DEFINE( 3, PUBLIC_PAYLOAD_READ    ,GATM_CHARACTERISTIC_PROPERTIES_READ,  256, GATM_SECURITY_PROPERTIES_NO_SECURITY,   MAKEUUID16(97,60,D0,77,A2,34,46,86,9E,20,D0,87,33,3C,2D,13))
