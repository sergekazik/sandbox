...
RING_BLE_PAIRING_SERVICES_DEFINE( 3, GET_PUBLIC_PAYLOAD, PROPERTY_RW_, 512, GATM_SECURITY_PROPERTIES_NO_SECURITY, MAKERINGUUID(02), MAKEPAYLOAD(""))
...
RING_BLE_PAIRING_SERVICES_DEFINE(19, GET_WIFI_STATUS   , PROPERTY_R__,  18, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(0A), MAKEPAYLOAD(""))
