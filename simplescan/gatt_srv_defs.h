...
#define RING_BLE_PAIRING_SERVICES_DEFINE(__arg0, __arg1, __arg2, __arg3, __arg4, __arg5, __argpld)    \
                static CharacteristicInfo_t Srv0Attr_##__arg1 = { __arg2, GATM_SECURITY_PROPERTIES_NO_SECURITY, __arg5,  FALSE, __arg3, __argpld };
#else // DEVELOPMENT_TEST_NO_SECURITY = 0
#define RING_BLE_PAIRING_SERVICES_DEFINE(__arg0, __arg1, __arg2, __arg3, __arg4, __arg5, __argpld)    \
                static CharacteristicInfo_t Srv0Attr_##__arg1 = { __arg2, __arg4, __arg5,  FALSE, __arg3,  __argpld };
...
RING_BLE_PAIRING_SERVICES_DEFINE( 1, SET_PUBLIC_KEY    , PROPERTY__W_, 512, GATM_SECURITY_PROPERTIES_NO_SECURITY, MAKERINGUUID(01), MAKEPAYLOAD(""))
RING_BLE_PAIRING_SERVICES_DEFINE( 3, GET_PUBLIC_PAYLOAD, 0xFFFFFFFF /*PROPERTY_RW_*/, 512, GATM_SECURITY_PROPERTIES_NO_SECURITY, MAKERINGUUID(02), MAKEPAYLOAD(""))
RING_BLE_PAIRING_SERVICES_DEFINE( 5, GET_NETWORKS      , PROPERTY_R__, 512, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(03), MAKEPAYLOAD(""))
RING_BLE_PAIRING_SERVICES_DEFINE( 7, SET_SSID_WIFI     , PROPERTY__W_,  36, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(04), MAKEPAYLOAD(""))
RING_BLE_PAIRING_SERVICES_DEFINE( 9, SET_PASSWORD      , PROPERTY__W_,  36, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(05), MAKEPAYLOAD(""))
RING_BLE_PAIRING_SERVICES_DEFINE(11, SET_PAIRING_START , PROPERTY__W_,  36, GATM_SECURITY_PROPERTIES_NO_SECURITY, MAKERINGUUID(06), MAKEPAYLOAD(""))
RING_BLE_PAIRING_SERVICES_DEFINE(13, GET_PAIRING_STATE , PROPERTY_R_N,  18, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(07), MAKEPAYLOAD("IDLE"))
RING_BLE_PAIRING_SERVICES_DEFINE(15, SET_LANGUAGE      , PROPERTY__W_,  18, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(08), MAKEPAYLOAD(""))
RING_BLE_PAIRING_SERVICES_DEFINE(17, SET_ZIPCODE       , PROPERTY__W_,  18, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(09), MAKEPAYLOAD(""))
RING_BLE_PAIRING_SERVICES_DEFINE(19, GET_WIFI_STATUS   , PROPERTY_R__,  18, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(0A), MAKEPAYLOAD("DISCONNECTED"))
RING_BLE_PAIRING_SERVICES_DEFINE(21, GET_SSID_WIFI     , PROPERTY_R__,  36, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(0B), MAKEPAYLOAD("Doorbells"))
RING_BLE_PAIRING_SERVICES_DEFINE(23, GET_SERIAL_NUMBER , PROPERTY_R__,  36, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(0C), MAKEPAYLOAD(""))
RING_BLE_PAIRING_SERVICES_DEFINE(25, GET_MAC_ADDRESS   , PROPERTY_R__,  18, GATM_SECURITY_PROPERTIES_ENCRYPTED,   MAKERINGUUID(0D), MAKEPAYLOAD("38:D2:69:F2:7E:01"))
