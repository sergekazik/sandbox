...
#ifdef RING_BLE_NOTIFY__SERVICES_DEFINE
#undef RING_BLE_NOTIFY__SERVICES_DEFINE
#endif
...
#define RING_BLE_PAIRING_SERVICES_DEFINE(__arg0, __arg1, __arg2, __arg3, __arg4, __arg5)    \
                static CharacteristicInfo_t Srv0Attr_##__arg1 = { __arg2, __arg4, __arg5,  FALSE, __arg3, strlen(#__arg1), (Byte_t *) #__arg1 };
#define RING_BLE_NOTIFY__SERVICES_DEFINE(__arg0, __arg1, __arg2, __arg3, __arg4, __arg5)    \
                static CharacteristicInfo_t Srv0Attr_##__arg1 = { GATM_CHARACTERISTIC_PROPERTIES_NOTIFY | __arg2, __arg4, __arg5,  FALSE, __arg3, 0, (Byte_t *) NULL };
#endif

#ifdef RING_PAIRING_TABLE_SERVICE_DEFINE_TABLE
#undef RING_PAIRING_TABLE_SERVICE_DEFINE_TABLE
#define RING_BLE_GATT_SERVER_TEST_DEFINE(__arg1, __arg2)
#define RING_BLE_PAIRING_SERVICES_DEFINE(__arg0, __arg1, __arg2, __arg3, __arg4, __arg5) { atCharacteristic, __arg0, (void *) &Srv0Attr_##__arg1},
#define RING_BLE_NOTIFY__SERVICES_DEFINE(__arg0, __arg1, __arg2, __arg3, __arg4, __arg5) { atCharacteristic, __arg0, (void *) &Srv0Attr_##__arg1},
#endif
...
#ifndef RING_BLE_NOTIFY__SERVICES_DEFINE
#define RING_BLE_NOTIFY__SERVICES_DEFINE(__arg0, __arg1, __arg2, __arg3, __arg4, __arg5)
#endif
...
RING_BLE_PAIRING_SERVICES_DEFINE( 1, PEER_PUBLIC_KEY_WRITE  ,GATM_CHARACTERISTIC_PROPERTIES_WRITE, 64, GATM_SECURITY_PROPERTIES_NO_SECURITY,   MAKEUUID16(97,60,D0,77,A2,34,46,86,9E,21,D0,87,33,3C,2D,15))
RING_BLE_PAIRING_SERVICES_DEFINE( 3, PUBLIC_PAYLOAD_READ    ,GATM_CHARACTERISTIC_PROPERTIES_READ,  64, GATM_SECURITY_PROPERTIES_NO_SECURITY,   MAKEUUID16(97,60,D0,77,A2,34,46,86,9E,20,D0,87,33,3C,2D,13))
...
RING_BLE_NOTIFY__SERVICES_DEFINE(17, STATE_READ             ,GATM_CHARACTERISTIC_PROPERTIES_READ,  16, GATM_SECURITY_PROPERTIES_ENCRYPTED,     MAKEUUID16(97,60,D0,77,A2,34,46,86,9E,20,D0,87,33,3C,2C,10))
